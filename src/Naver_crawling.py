...
def month(x,year):
    ...
    if x == '06' and year == 2020 :
        for i , j in zip(['26', '27', '28', '29'],['27', '28', '29', '30']) :
            df = crawling_process(start=str(year)+'.'+str(x)+'.'+str(i)+'.', end=str(year)+'.'+str(x)+'.'+str(j)+'.', query='백신')
    elif x == '02' :
...
for k in ['06'] : month_agg(k,year =2020)
